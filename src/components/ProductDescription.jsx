...
.pdesc-reviewer-name { font-size: 0.82rem; font-weight: 700; color: #0f172a; }
.pdesc-review-date { font-size: 0.775rem; color: #94a3b8; margin-top: 3px; font-weight: 400; }
...
.pdesc-store {
    ...
    border-radius: 18px; max-width: 360px;
...
const SmartAvatar = ({ name, image }) => {
    ...
    if (!image || !imgOk) {
        return (
            <div className="pdesc-avatar-placeholder">
                {initial}
            </div>
        );
    }
            ...
            <div className="pdesc-root">
                ...
                {product.store && (
                    <div className="pdesc-store">
                        <img
                            src={product.store?.logo || '/default-avatar.png'}
                            alt={product.store?.name || 'Store'}
                            className="pdesc-store-logo"
                        />
                        <div>
